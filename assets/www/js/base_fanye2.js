...
//                $(".main1").hide();
            ...
            success: function(msg) {
                var dotobj=doT.template(msg);
                    ...
                    _.delay(function(){
                        if(curmodel=="next"){
//                            $(".main1").removeClass("translate-actionnext").removeClass("translate-actionpre").addClass("translate-actionnext").show();
                        }else if(curmodel=="pre"){
//                            $(".main1").removeClass("translate-actionnext").removeClass("translate-actionpre").addClass("translate-actionpre").show();
                        }
                    },0);
    ...
    //动态绑定跳转下一页的事件
    $("#page1").delegate("[to]",touchevent,function(event){
    ...
    //动态绑定返回上一页的事件
    $("#page1").delegate(".pre[from]",touchevent,function(event){
        event.stopPropagation();
        event.preventDefault();
    ...
    //动态绑定收起和展开事件
    $("#page1").delegate(".hassub",touchevent,function(){
    ...
    //动态绑定动画单击事件
    $("#page1").delegate(".m_pingfen .pf_display",touchevent,function(){
        animateindex.reload();
    });
});