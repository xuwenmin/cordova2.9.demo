...
$(function() {
    ...
    $(".header .righticon a").on("click",function(e) {
        e.preventDefault();
    ...
    $(".content .ultitle li").on("click",function() {
    ...
    $(".content .content4_2 li").on("touchstart",function() {
    ...
    $(".content .contentlist5_2 li").on("touchstart",function() {
    ...
    $(".content_footer>div").each(function(index) {
    ...
    //绑定页脚的切换事件
    var agoarg = ["1_1.html", "2_1.html", "3_1.html", "8_1.html"];
    ...
    //绑定所有返回的时候跳转到首页
    $(".header img[src*='2_10']").on("click",function() {
    ...
    //绑定注册页面的JS
    $(".content .bigdescinfo .register a.areg").on("click",function(e) {
        e.preventDefault();
        window.location = "10_1.html";
    });

    //绑定注册到最后一步
    $(".content .buttondiv  a.aregtonext").on("click",function(e) {
        e.preventDefault();
        window.location = "10_3.html";
    });

    //绑定最后一步到完成页
    $(".content .buttondiv  a.aendtoover").on("click",function(e) {
        e.preventDefault();
        window.location = "10_4.html";
    });

    //绑定完成到注册成功
    $(".content .buttondiv  a.aovertoyes").on("click",function(e) {
        e.preventDefault();
        window.location = "10_5.html";
    });

    //绑定注册成功到登录
    $(".content .buttondiv  a.ayestologin").on("click",function(e) {
        e.preventDefault();
        window.location = "9_1.html";
    });

    //登录成功后跳到登录页面
    $(".content .bigdescinfo  a.alogintoindex").on("click",function(e) {
        e.preventDefault();
        window.location = "1_2.html";
    });

    //绑定2_1里的搜索跳转
    $(".header .righticon img.find2_1").on("click",function() {
        window.location = "2_3.html";
    });

    //绑定2_1 中的li跳转
    $(".content .list2_1 li").on("click",function() {
        window.location = "2_4.html";
    });

    //绑定2_4 中的li跳转
    $(".list2_4 li").on("click",function() {
        window.location = "2_5.html";
    });

    //绑定3_1里的搜索跳转
    $(".header .righticon img.find3_1").on("click",function() {
        window.location = "3_3.html";
    });

    //绑定3_1 中的li跳转
    $(".content .list3_1 li").on("click",function() {
        window.location = "3_5.html";
    });

    //绑定3_5同意查看详情按钮
    $(".content .buttondiv a.find3_5").on("click",function() {
    ...
    //绑定5_1中跳转到图表
    $(".contentlist5_2 img.list5_1").on("click",function(e) {
        e.stopPropagation();
        window.location = "5_4.html";
    });

    //绑定5_4中发送信息
    $(".content .descinfo img.send5_4").on("click",function(e) {
        e.stopPropagation();
        window.location = "5_5.html";
    });

    //绑定6_1两按钮跳转
    $(".content .buttondiv a.a6_1_1").on("click",function(e) {
        e.preventDefault();
        window.location = "6_2.html";
    });
    $(".content .buttondiv a.a6_1_2").on("click",function(e) {
        e.preventDefault();
        window.location = "6_6.html";
    });

    //绑定6_2下一步跳转到6_3最后一步
    $(".content .buttondiv a.a62next").on("click",function(e) {
        e.preventDefault();
        window.location = "6_3.html";
    });
    $(".content .buttondiv a.a63end").on("click",function(e) {
        e.preventDefault();
        window.location = "6_5.html";
    });

    //绑定7_1到7_2同意委托
    $(".content .buttondiv a.a71to72").on("click",function(e) {
        e.preventDefault();
        window.location = "7_2.html";
    });
    //绑定7_2到7_3同意委托
    $(".content .buttondiv a.a72to73").on("click",function(e) {
        e.preventDefault();
        window.location = "7_3.html";
    });
    //绑定7_3到7_4同意委托
    $(".content .buttondiv a.a73to74").on("click",function(e) {
        e.preventDefault();
        window.location = "7_4.html";
    });
    //绑定7_4到7_5同意委托
    $(".content .buttondiv a.a74to75").on("click",function(e) {
        e.preventDefault();
        window.location = "7_5.html";
    });
    //绑定7_5到7_6同意委托
    $(".content .buttondiv a.a75to76").on("click",function(e) {
        e.preventDefault();
        window.location = "7_6.html";
    });
    //绑定7_6到7_7同意委托
    $(".content .buttondiv a.a76to77").on("click",function(e) {
        e.preventDefault();
  ...
  /*
    ...
    function loaded() {
	 ...
	 function onDeviceReady() {
           ...
           var a=device.version;
           var v=a.split('.')[0];
           if(v=='2'){
              //用transition   
               $(".content").eq(0).css("left","2000px").show();
               _.delay(function(){
			        $(".content").eq(0).addClass("translate-action2-3");
			    },0);
           }else if(v=='4'){
              //用animation
             $(".content").eq(0).addClass("translate-action4").show();
           } 
           _.delay(function(){
              loaded();
           },0); 
